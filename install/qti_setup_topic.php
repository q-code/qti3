...
case 'ibase':
  ...
  firstpostname varchar(64) default NULL,
  lastpostname varchar(64) default NULL,
  firstpostdate varchar(20) default "0",
  lastpostdate varchar(20) default "0",
  actorid integer default NULL,
  actorname varchar(64) default NULL,
  notifiedid integer default NULL,
  notifiedname varchar(64) default NULL,
...
{
  echo '<div class="setup_err">',sprintf ($L['E_install'],$qti_prefix.'qtitopic',$qti_database,$qti_user),'</div>';
