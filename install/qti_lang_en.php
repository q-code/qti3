...
$L['Install_db'] = 'Installing QuickTicket tables';
...
$L['E_save'] = '<br/><br/><span class="bold">Problem to write into /bin/ folder</span><br/><br/>Possible causes:<br/>&raquo;&nbsp;File /bin/config.php is missing.<br/>&raquo;&nbsp;File /bin/config.php is read-only.<br/>';
