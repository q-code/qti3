...
$streetView = substr($_SESSION[QT]['m_map_gbuttons'],1,1)=='1' ? 'true' : 'false';
$fullView = substr($_SESSION[QT]['m_map_gbuttons'],4,1)=='1' ? 'true' : 'false';
$scaleBar = substr($_SESSION[QT]['m_map_gbuttons'],3,1)=='1' ? 'true' : 'false';

if ( !empty($oVIP->selfurl) && isset($_SESSION[QT]['viewmode']) && $_SESSION[QT]['viewmode']==='c' ) {
if ( $oVIP->selfurl==='qti_item.php' || $oVIP->selfurl==='qti_calendar.php' ) {
  $streetView = 'false';
  $scaleBar = 'false';
}}
