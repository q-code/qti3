...
$strVersion='v3.0';
$oVIP->selfurl = 'qtim_rss_install.php';
$oVIP->selfname = 'Installation module RSS '.$strVersion;
...
$strQTI = QTIVERSION; if ( substr(QTIVERSION,0,1)=='v') $strQTI = substr(QTIVERSION,1);
$arrQTI = explode('.',$strQTI);
if ( intval($arrQTI[0])<2 ) $error="Your QuickTicket version is $strQTI. Please, upgrade to QuickTicket 2.3 before installing this module...";
...
if ( empty($error) )
{
  ...
  $oDB->Exec('INSERT INTO '.TABSETTING.' (param,setting,loaded) VALUES ("module_rss","RSS","1")');
  $oDB->Exec('INSERT INTO '.TABSETTING.' (param,setting,loaded) VALUES ("m_rss","0","1")');
  $oDB->Exec('INSERT INTO '.TABSETTING.' (param,setting,loaded) VALUES ("m_rss_conf","V 2.0 3","1")');
  $_SESSION[QT]['module_rss'] = 'RSS';
  $_SESSION[QT]['m_rss'] = '0';
  $_SESSION[QT]['m_rss_conf'] = 'V 2.0 3';
}
