...
$L['H_Unregister']='<p>By unregistering, you will stop having access to this application as a member.<br />Your profile will be deleted and your account will no more be visible in the memberlist. Your messages will remain visible.<br />If other users try to access your profile, they will see the Visitor profile.</p><p>Enter your password to confirm unregistration...</p>';
...
$L['Reg_help']='Please fill in this form to complete your registration.<br /><br />Username and password must be at least 4 characters without tags or trailing spaces.<br /><br />E-mail address will be used to send you a new password if you forgot it. It is visible for registrered members only. To make it invisible, change your privacy settings in your profile.<br /><br />If you are visually impaired or cannot otherwise read the security code please contact the <a href="mailto:'.$_SESSION[QT]['admin_email'].'">Administrator</a> for help.<br /><br />';
