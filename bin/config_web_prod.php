...
define('QTI_BACKBUTTON', '<i class="fa fa-chevron-left"></i></a>');  // use FALSE to hide backbutton. ex: &#9665;
define('QTI_GOTOBUTTON', '<i class="fa fa-chevron-circle-right fa-lg"></i>'); // use to go to the last message. ex: &rsaquo;
...
define('QTI_SHOW_GOTOLIST',   true);  // show section selection-list in the bottom bar
...
define('QTI_MY_REPLY', '<i class="fa fa-registered"></i>'); // Symbol indicating the that i replied to the ticket in the ticket list. Using False will DISABLE the search and the symbol.
...
define('MEMCACHE_HOST', 'tcp://10.10.0.5'); // Memcache server hostname (ex: 'localhost' or 'tcp://10.10.0.5'). Use FALSE to disable memcache.
...
define('MEMCACHE_LIVETIME', 600);           // Livetime (in seconds) of the cache. Recommanded: 600
